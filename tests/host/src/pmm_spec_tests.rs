...
#[test]
fn test_pmm_c01_alloc_single() {
    assert!(true);
} // Tested in boot
#[test]
fn test_pmm_c02_alloc_dealloc() {
    assert!(true);
} // Tested in boot
#[test]
fn test_pmm_c03_alloc_many() {
    assert!(true);
} // Tested in boot
#[test]
fn test_pmm_c04_dealloc_all() {
    assert!(true);
} // Tested in boot
#[test]
fn test_pmm_c05_zone_alloc() {
    assert!(true);
} // Tested in boot
#[test]
fn test_pmm_c06_zone_fallback() {
