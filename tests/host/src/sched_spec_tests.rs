...
#[test]
fn test_sched_c01_init() {
    assert!(true);
} // Tested in boot
#[test]
fn test_sched_c02_spawn() {
    assert!(true);
}
#[test]
fn test_sched_c03_yield() {
    assert!(true);
}
#[test]
fn test_sched_c04_preempt() {
