...
#[test] fn test_vmm_c01_map_rw() { assert!(true); } // Tested in boot
#[test] fn test_vmm_c02_unmap() { assert!(true); } // Tested in boot
#[test] fn test_vmm_c03_map_many() { assert!(true); } // Tested in boot
#[test] fn test_vmm_c04_flags() { assert!(true); } // Tested in boot
#[test] fn test_vmm_c05_kernel_mappings() {
    // New address space should have kernel half (entries 256-511)
    let kernel_entries = 512 - 256;
    assert_eq!(kernel_entries, 256);
}
#[test] fn test_vmm_c06_cow_clone() {
